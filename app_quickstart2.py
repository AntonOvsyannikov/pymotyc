...
async def main():
    ...
    employee = await Warehouse.empolyees.find_one({Employee.name: 'Vasya Pupkin'})
    ...
    employee = await Warehouse.empolyees.save(Employee(name='Frosya Taburetkina', age=21))
    employee.age += 1
    await employee.save()
    assert (await Warehouse.empolyees.find_one({Employee.name: 'Frosya Taburetkina'})).age == 22
